...
CREATE TABLE anthropos (
    ...
    tilefono        VARCHAR(15)     NULL,
    PRIMARY KEY (amka)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE tipos_proswpikou(
    typos_name VARCHAR(20) NOT NULL,
...
CREATE TABLE proswpiko (
    ...
    Foreign key(typos_proswpikou) REFERENCES tipos_proswpikou(typosId),
 ...
 CREATE TABLE iatros (
    ...
    vathmida        VARCHAR(20)     NOT NULL
        CHECK (vathmida IN ('Ειδικευόμενος','Επιμελητής Β','Επιμελητής Α','Διευθυντής')),
